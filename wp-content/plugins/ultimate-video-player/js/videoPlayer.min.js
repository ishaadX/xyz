...
this.positionPoster();this.positionVideoAdBoxInside();this.positionSkipAdBox();this.positionToggleAdPlayBox();this.resizeBars();this.autohideControls()}};c.fn.resizeAll=function(a){if(this.options.responsive){a=this.parent.width()/(16/9);this.parent.height(a);switch(this.options.playlist){case "Right playlist":this.stretching?(370>this.element.width()?this.infoWindow.css({width:"100%"}):this.infoWindow.css({width:370}),360>this.parent.width()?this.videoTrack.hide():this.videoTrack.show(),338>this.parent.width()?
this.sep2.hide():this.sep2.show(),331>this.parent.width()?this.rewindBtn.hide():this.rewindBtn.show(),308>this.parent.width()?this.sep3.hide():this.sep3.show(),302>this.parent.width()?this.infoBtn.hide():this.infoBtn.show(),277>this.parent.width()?this.sep4.hide():this.sep4.show(),262>this.parent.width()?this.timeElapsed.hide():this.timeElapsed.show(),262<this.parent.width()&&(this.timeTotal.show(),this.sep5.show(),this.unmuteBtn.show(),this.volumeTrack.show(),this.sep6.show(),this.fsEnter.show())):
(370>this.element.width()?this.infoWindow.css({width:"100%"}):this.infoWindow.css({width:370}),439>this.parent.width()?this.videoTrack.hide():this.videoTrack.show(),411>this.parent.width()?this.sep2.hide():this.sep2.show(),406>this.parent.width()?this.rewindBtn.hide():this.rewindBtn.show(),381>this.parent.width()?this.sep3.hide():this.sep3.show(),375>this.parent.width()?this.infoBtn.hide():this.infoBtn.show(),350>this.parent.width()?this.sep4.hide():this.sep4.show(),335>this.parent.width()?this.timeElapsed.hide():
this.timeElapsed.show(),302>this.parent.width()?this.timeTotal.hide():this.timeTotal.show(),287>this.parent.width()?this.sep5.hide():this.sep5.show(),460>this.parent.width()?(this.toggleAdPlayBox.css({width:33}),b(this.toggleAdPlayBox).find(".ult_vp_toggleAdPlayBoxTitle").hide(),this.videoAdBoxInside.css({width:132}),b(this.elementAD).find(".ult_vp_adsTitleInside").html("Advertisement - ")):(this.toggleAdPlayBox.css({width:97}),b(this.toggleAdPlayBox).find(".ult_vp_toggleAdPlayBoxTitle").show(),this.videoAdBoxInside.css({width:190}),
b(this.elementAD).find(".ult_vp_adsTitleInside").html("Your video will resume in")),625>this.parent.width()?(this._playlist.playlist.css({width:75}),this.mainContainer.find(".ult_vp_itemRight").hide()):"Transparent"!=this.options.skinPlayer&&(this._playlist.playlist.css({width:260}),this.mainContainer.find(".ult_vp_itemRight").show()));break;case "Bottom playlist":376>this.parent.width()?this.embedBtn.hide():this.embedBtn.show();364>this.parent.width()?this.videoTrack.hide():this.videoTrack.show();
336>this.parent.width()?this.sep2.hide():this.sep2.show();329>this.parent.width()?this.rewindBtn.hide():this.rewindBtn.show();306>this.parent.width()?this.sep3.hide():this.sep3.show();301>this.parent.width()?this.infoBtn.hide():this.infoBtn.show();275>this.parent.width()?this.sep4.hide():this.sep4.show();260>this.parent.width()?this.timeElapsed.hide():this.timeElapsed.show();break;case "Off":364>this.parent.width()?this.videoTrack.hide():this.videoTrack.show(),336>this.parent.width()?this.sep2.hide():
this.sep2.show(),329>this.parent.width()?this.rewindBtn.hide():this.rewindBtn.show(),306>this.parent.width()?this.sep3.hide():this.sep3.show(),301>this.parent.width()?this.infoBtn.hide():this.infoBtn.show(),275>this.parent.width()?this.sep4.hide():this.sep4.show(),260>this.parent.width()?this.timeElapsed.hide():this.timeElapsed.show()}this.stretching?"Right playlist"==this.options.playlist?(this.element.width(this.parent.parent().width()),this.element.height(this._playlist.playlist.height())):"Bottom playlist"==
this.options.playlist?(this.element.width(this.parent.parent().width()),this.element.height(this.parent.height())):"Off"==this.options.playlist&&(this.element.width(this.parent.parent().width()),this.element.height(this.parent.parent().height())):"Right playlist"==this.options.playlist?(this.element.width(this.parent.parent().width()-this._playlist.playlist.width()),this.element.height(this._playlist.playlist.height())):"Bottom playlist"==this.options.playlist?(this.element.width(this.parent.parent().width()),
this.element.height(this.parent.height()-this._playlist.playlist.height())):"Off"==this.options.playlist&&(this.element.width(this.parent.parent().width()),this.element.height(this.parent.height()));this._playlist.resizePlaylist();this.elementAD.width(this.element.width());this.elementAD.height(this.element.height());-1!=navigator.platform.indexOf("iPhone")&&"HTML5"==this.options.videoType&&(this.videoElement.width(this.element.width()-48),this.videoElementAD.width(this.element.width()-48),this.videoElement.height(this.element.height()-
26),this.videoElementAD.height(this.element.height()-26));this.positionEmbedWindow();this.positionInfoWindow()}else{this.newPlayerWidth=b(window).width()-this.mainContainer.position().left;if("Right playlist"==this.options.playlist||"Off"==this.options.playlist)this.newPlayerHeight=this.newPlayerWidth/(16/9);"Bottom playlist"==this.options.playlist&&(this.newPlayerHeight=this.newPlayerWidth/(16/9)-64);if(this.newPlayerWidth<this.options.videoPlayerWidth)switch(this.options.playlist){case "Right playlist":"Transparent"!=
this.options.skinPlayer||this.stretching?this.stretching?(364>this.newPlayerWidth?this.videoTrack.hide():this.videoTrack.show(),334>this.newPlayerWidth?this.sep2.hide():this.sep2.show(),383>this.newPlayerWidth?this.embedBtn.hide():this.embedBtn.show(),326>this.newPlayerWidth?this.rewindBtn.hide():this.rewindBtn.show(),310>this.newPlayerWidth?this.infoBtn.hide():this.infoBtn.show(),290>this.newPlayerWidth?this.sep4.hide():this.sep4.show(),270>this.newPlayerWidth?this.timeElapsed.hide():this.timeElapsed.show(),
236>this.newPlayerWidth?this.timeTotal.hide():this.timeTotal.show(),213>this.newPlayerWidth&&(this.newPlayerWidth=213)):(623>this.newPlayerWidth?(this.videoTrack.hide(),this.infoWindow.css({width:"100%"})):(this.videoTrack.show(),this.infoWindow.css({width:370})),593>this.newPlayerWidth?this.sep2.hide():this.sep2.show(),590>this.newPlayerWidth?this.rewindBtn.hide():this.rewindBtn.show(),587>this.newPlayerWidth?this.embedBtn.hide():this.embedBtn.show(),564>this.newPlayerWidth?this.sep3.hide():this.sep3.show(),
560>this.newPlayerWidth?this.infoBtn.hide():this.infoBtn.show(),552>this.newPlayerWidth?this.sep4.hide():this.sep4.show(),522>this.newPlayerWidth?this.timeElapsed.hide():this.timeElapsed.show(),491>this.newPlayerWidth?this.timeTotal.hide():this.timeTotal.show(),479>this.newPlayerWidth?(this.toggleAdPlayBox.css({width:33}),b(this.toggleAdPlayBox).find(".ult_vp_toggleAdPlayBoxTitle").hide()):(this.toggleAdPlayBox.css({width:97}),b(this.toggleAdPlayBox).find(".ult_vp_toggleAdPlayBoxTitle").show()),435>
this.newPlayerWidth&&(this.newPlayerWidth=435)):(490>this.newPlayerWidth?this.videoTrack.hide():this.videoTrack.show(),458>this.newPlayerWidth?(this.sep1.hide(),this.sep2.hide()):(this.sep1.show(),this.sep2.show()),423>this.newPlayerWidth?this.rewindBtn.hide():this.rewindBtn.show(),411>this.newPlayerWidth?this.embedBtn.hide():this.embedBtn.show(),403>this.newPlayerWidth?this.sep3.hide():this.sep3.show(),394>this.newPlayerWidth?this.infoBtn.hide():this.infoBtn.show(),372>this.newPlayerWidth?this.sep4.hide():
this.sep4.show(),352>this.newPlayerWidth?this.timeElapsed.hide():this.timeElapsed.show(),315>this.newPlayerWidth?this.timeTotal.hide():this.timeTotal.show(),255>this.newPlayerWidth?this.sep5.hide():this.sep5.show(),255>this.newPlayerWidth&&(this.newPlayerWidth=255));break;case "Bottom playlist":364>this.newPlayerWidth?this.videoTrack.hide():this.videoTrack.show();334>this.newPlayerWidth?this.sep2.hide():this.sep2.show();383>this.newPlayerWidth?this.embedBtn.hide():this.embedBtn.show();326>this.newPlayerWidth?
this.rewindBtn.hide():this.rewindBtn.show();310>this.newPlayerWidth?this.infoBtn.hide():this.infoBtn.show();290>this.newPlayerWidth?this.sep4.hide():this.sep4.show();270>this.newPlayerWidth?this.timeElapsed.hide():this.timeElapsed.show();236>this.newPlayerWidth?this.timeTotal.hide():this.timeTotal.show();213>this.newPlayerWidth&&(this.newPlayerWidth=213);break;case "Off":364>this.newPlayerWidth?this.videoTrack.hide():this.videoTrack.show(),334>this.newPlayerWidth?this.sep2.hide():this.sep2.show(),
326>this.newPlayerWidth?this.rewindBtn.hide():this.rewindBtn.show(),310>this.newPlayerWidth?this.infoBtn.hide():this.infoBtn.show(),290>this.newPlayerWidth?this.sep4.hide():this.sep4.show(),270>this.newPlayerWidth?this.timeElapsed.hide():this.timeElapsed.show(),236>this.newPlayerWidth?this.timeTotal.hide():this.timeTotal.show(),213>this.newPlayerWidth&&(this.newPlayerWidth=213)}else{this.newPlayerWidth=this.options.videoPlayerWidth;if("Right playlist"==this.options.playlist||"Off"==this.options.playlist)this.newPlayerHeight=
this.options.videoPlayerHeight;"Bottom playlist"==this.options.playlist&&(this.newPlayerHeight=this.options.videoPlayerHeight-64);this.sep1.show();this.sep2.show();this.sep3.show();this.sep4.show();this.videoTrack.show();this.timeElapsed.show();this.timeTotal.show();this.volumeTrack.show();this.rewindBtn.show();this.unmuteBtn.show();this.embedBtn.show();this.infoBtn.show()}"Right playlist"==this.options.playlist?(-1!=navigator.platform.indexOf("iPhone")&&"HTML5"==this.options.videoType&&(this.videoElement.height(this.newPlayerHeight-
26),this.videoElementAD.height(this.newPlayerHeight-26)),this.element.height(this.newPlayerHeight),this.mainContainer.css({width:this.newPlayerWidth,height:this.newPlayerHeight})):"Bottom playlist"==this.options.playlist?(-1!=navigator.platform.indexOf("iPhone")&&"HTML5"==this.options.videoType&&(this.videoElement.width(this.newPlayerWidth-48),this.videoElementAD.width(this.newPlayerWidth-48)),this.element.width(this.newPlayerWidth),this.mainContainer.css({width:this.newPlayerWidth,height:this.newPlayerHeight+
...
height:this.newPlayerHeight}));this.stretching?"Right playlist"==this.options.playlist?(-1!=navigator.platform.indexOf("iPhone")&&"HTML5"==this.options.videoType&&(this.videoElement.width(this.newPlayerWidth-48),this.videoElementAD.width(this.newPlayerWidth-48)),this.element.width(this.newPlayerWidth)):"Bottom playlist"==this.options.playlist?(-1!=navigator.platform.indexOf("iPhone")&&"HTML5"==this.options.videoType&&(this.videoElement.height(this.newPlayerHeight+this._playlist.playlistH-26),this.videoElementAD.height(this.newPlayerHeight+
this._playlist.playlistH-26)),this.element.height(this.newPlayerHeight+this._playlist.playlistH)):"Off"==this.options.playlist&&(-1!=navigator.platform.indexOf("iPhone")&&"HTML5"==this.options.videoType&&(this.videoElement.width(this.newPlayerWidth-48),this.videoElementAD.width(this.newPlayerWidth-48)),this.element.width(this.newPlayerWidth)):"Right playlist"==this.options.playlist?(-1!=navigator.platform.indexOf("iPhone")&&"HTML5"==this.options.videoType&&(this.videoElement.width(this.newPlayerWidth-
this._playlist.playlistW-48),this.videoElementAD.width(this.newPlayerWidth-this._playlist.playlistW-48)),this.element.width(this.newPlayerWidth-this._playlist.playlistW),this._playlist.resizePlaylist(this.newPlayerWidth,this.newPlayerHeight)):"Bottom playlist"==this.options.playlist?(-1!=navigator.platform.indexOf("iPhone")&&"HTML5"==this.options.videoType&&(this.videoElement.height(this.newPlayerHeight-26),this.videoElementAD.height(this.newPlayerHeight-26)),this.element.height(this.newPlayerHeight),
this._playlist.resizePlaylist(this.newPlayerWidth,this.newPlayerHeight)):"Off"==this.options.playlist&&(-1!=navigator.platform.indexOf("iPhone")&&"HTML5"==this.options.videoType&&(this.videoElement.width(this.newPlayerWidth-48),this.videoElementAD.width(this.newPlayerWidth-48)),this.element.width(this.newPlayerWidth));this.elementAD.width(this.element.width());this.elementAD.height(this.element.height());-1!=navigator.platform.indexOf("iPhone")&&"HTML5"==this.options.videoType&&this.playBtnScreen&&
this.playBtnScreen.hide();if("youtube"==this.options.videoType&&void 0!=this._playlist.youtubePlayer)if(this.realFullscreenActive)this.element.width(b(document).width()),this.element.height(b(document).height()),this._playlist.youtubePlayer.setSize(this.element.width(),this.element.height());else switch(this.options.playlist){case "Right playlist":this._playlist.youtubePlayer.setSize(this.newPlayerWidth-this._playlist.playlistW,this.newPlayerHeight);break;case "Bottom playlist":this._playlist.youtubePlayer.setSize(this.newPlayerWidth,
this.newPlayerHeight);break;case "Off":this._playlist.youtubePlayer.setSize(this.newPlayerWidth,this.newPlayerHeight)}this.positionEmbedWindow();this.positionInfoWindow();this.positionAds()}this.positionVideoAdBoxInside();this.positionSkipAdBox();this.positionToggleAdPlayBox();this.resizeVideoTrack();this.positionOverScreenButtons();this.positionShareWindow();this.positionAds();this.resizeBars();this.positionLogo();this.positionPoster();-1!=navigator.platform.indexOf("iPhone")&&(this.embedBtnClose.hide(),
this.infoBtnClose.hide(),this.shareWindow.css({top:this.screenBtnsWindow.height(),right:13}))};c.fn.autohideControls=function(){var a=b(this.element),c=!1,d=1E3*this.options.autohideControls,e=0,f=function(){c&&a.trigger("idle",!1);c=!1;e=0};a.bind("mousemove keydown DOMMouseScroll mousewheel mousedown reset.idle",f);var w=setInterval(function(){e>=d?(f(),c=!0,a.trigger("idle",!0)):e+=1E3},1E3);a.unload(function(){clearInterval(w)})};c.fn.resizeBars=function(){this.downloadWidth=this.buffered/this.video.duration*
this.videoTrack.width();this.videoTrackDownload.css("width",this.downloadWidth);this.progressWidth=this.video.currentTime/this.video.duration*this.videoTrack.width();this.videoTrackProgress.css("width",this.progressWidth);this.progressWidthAD=this.videoAD.currentTime/this.videoAD.duration*this.elementAD.width();this.progressAD.css("width",this.progressWidthAD)};c.fn.createLogo=function(){var a=this;this.logoImg=b("<div/>");this.logoImg.addClass("ult_vp_logo");this.img=new Image;this.img.src=a.options.logoPath;
b(this.img).load(function(){a.logoImg.append(a.img);a.positionLogo()});"Yes"==a.options.logoShow&&this.element.append(this.logoImg);"Yes"==a.options.logoClickable&&(this.logoImg.bind(this.CLICK_EV,b.proxy(function(){window.open(a.options.logoGoToLink)},this)),this.logoImg.mouseover(function(){b(this).stop().animate({opacity:.7},200)}),this.logoImg.mouseout(function(){b(this).stop().animate({opacity:1},200)}),b(".ult_vp_logo").css("cursor","pointer"))};c.fn.positionLogo=function(){"bottom-right"==
this.options.logoPosition?this.logoImg.css({bottom:this.controls.height()+this.toolTip.height()+8,right:buttonsMargin}):"bottom-left"==this.options.logoPosition&&this.logoImg.css({bottom:this.controls.height()+this.toolTip.height()+8,left:buttonsMargin})};c.fn.createAds=function(){var a=this;this.adTextWindow=b("<div/>");this.adTextWindow.addClass("ult_vp_textAdsWindow");this.element.append(this.adTextWindow);this.adTextWindowWrapper=b("<div/>");this.adTextWindowWrapper.addClass("ult_vp_textAdsWindowWrapper");
this.adTextWindow.append(this.adTextWindowWrapper);this.adTextContent=b("<div/>");this.adTextContent.addClass("ult_vp_textAdsContent");this.adTextWindowWrapper.append(this.adTextContent);this.adTextContent.append('<p class="ult_vp_textAdsTexts">'+a._playlist.videos_array[a._playlist.videoid].textAd+"</p>");this.scroll=new iScroll(a.adTextContent[0],{bounce:!1,momentum:!0});this.adTextWindow.hide();this.adTextWindow.css({opacity:0});this.adImg=b("<div/>");this.adImg.addClass("ult_vp_ads");a.image=
new Image;a.image.src=a._playlist.videos_array[a._playlist.videoid].popupImg;b(a.image).load(function(){a.adImg.append(a.image);a.positionAds();a.adImg.append(a.adClose)});this.element.append(this.adImg);this.adImg.hide();this.adImg.css({opacity:0});this.adClose=b("<div />");this.adClose.addClass("ult_vp_adClose");this.adClose.css({bottom:0});this.adClose.bind(this.START_EV,b.proxy(function(){a.adOn=!0;a.toggleAdWindow()},this));this.adClose.mouseover(function(){b(this).stop().animate({opacity:.7},
200)});this.adClose.mouseout(function(){b(this).stop().animate({opacity:1},200)});this.textAdClose=b("<div />");this.textAdClose.addClass("ult_vp_adClose");this.textAdClose.css({bottom:0});this.textAdClose.bind(this.START_EV,b.proxy(function(){a.textAdOn=!0;a.toggleTextAdWindow()},this));this.textAdClose.mouseover(function(){b(this).stop().animate({opacity:.7},200)});this.textAdClose.mouseout(function(){b(this).stop().animate({opacity:1},200)});this.adTextWindow.append(this.textAdClose)};c.fn.positionAds=
function(){this.adImg.css({bottom:this.controls.height()+40,left:this.element.width()/2-this.adImg.width()/2});this.adTextWindow.css({bottom:this.controls.height()+40,left:this.element.width()/2-this.adTextWindow.width()/2})};c.fn.newAd=function(a,c){var d=this;this.adImg.hide();d.image.src="";d.image.src=d._playlist.videos_array[d._playlist.videoid].popupImg;b(d.image).bind(this.START_EV,b.proxy(function(){window.open(d._playlist.videos_array[d._playlist.videoid].popupAdGoToLink);switch(d.options.videoType){case "HTML5":d.pause();
break;case "youtube":d._playlist.youtubePlayer.pauseVideo();break;case "vimeo":d._playlist.vimeoPlayer.api("pause")}},this))};c.fn.newTextAd=function(a,c){var d=this;this.adTextWindowWrapper.bind(this.START_EV,b.proxy(function(){window.open(d._playlist.videos_array[d._playlist.videoid].textAdGoToLink);switch(d.options.videoType){case "HTML5":d.pause();break;case "youtube":d._playlist.youtubePlayer.pauseVideo();break;case "vimeo":d._playlist.vimeoPlayer.api("pause")}},this))};c.fn.showVideoElements=
function(){this.videoElement.show();this.videoElementAD.show()};c.fn.hideVideoElements=function(){this.videoElement.hide();this.videoElementAD.hide()};c.fn.setupAutoplay=function(){this.options.autoplay?this.play():this.options.autoplay||(this.pause(),this.preloader.hide())};c.fn.createNowPlayingText=function(){this.options.loadRandomVideoOnStart?this.element.append('<p class="ult_vp_nowPlayingText">'+this._playlist.videos_array[this._playlist.rand].title+"</p>"):this.element.append('<p class="ult_vp_nowPlayingText">'+
this._playlist.videos_array[0].title+"</p>");"No"==this.options.nowPlayingText&&this.element.find(".ult_vp_nowPlayingText").hide()};c.fn.createInfoWindowContent=function(){this.options.loadRandomVideoOnStart?(this.infoWindow.append('<p class="ult_vp_infoTitle">'+this._playlist.videos_array[this._playlist.rand].title+"</p>"),this.infoWindow.append('<p class="ult_vp_infoText">'+this._playlist.videos_array[this._playlist.rand].info_text+"</p>")):(this.infoWindow.append('<p class="ult_vp_infoTitle">'+
this._playlist.videos_array[0].title+"</p>"),this.infoWindow.append('<p class="ult_vp_infoText">'+this._playlist.videos_array[0].info_text+"</p>"));this.infoWindow.hide();this.positionInfoWindow()};c.fn.createSkipAd=function(){var a=this;this.skipAdBox=b("<div />").attr("title","Skip Ad").addClass("ult_vp_skipAdBox").bind(a.CLICK_EV,function(){a.closeAD()}).hide();this.elementAD.append(this.skipAdBox);this.skipAdBoxIcon=b("<span />").attr("aria-hidden","true").addClass("fa").addClass("fa-step-forward");
this.skipAdBox.append(this.skipAdBoxIcon);this.skipAdBox.append('<p class="ult_vp_skipAdTitle">Skip Ad</p>');this.positionSkipAdBox()};c.fn.createAdTogglePlay=function(){var a=this;this.toggleAdPlayBox=b("<div />").attr("title","Play/pause ad").addClass("ult_vp_toggleAdPlayBox").bind(a.CLICK_EV,function(){a.togglePlayAD();a.ADTriggered=!0}).hide();this.elementAD.append(this.toggleAdPlayBox);this.toggleAdPlayBoxIcon=b("<span />").attr("aria-hidden","true").addClass("fa").addClass("fa-pauseAD");this.toggleAdPlayBox.append(this.toggleAdPlayBoxIcon);
this.toggleAdPlayBox.append('<p class="ult_vp_toggleAdPlayBoxTitle">Pause Ad</p>');this.positionToggleAdPlayBox()};c.fn.createVideoAdTitleInsideAD=function(){this.videoAdBoxInside=b("<div />");this.videoAdBoxInside.addClass("ult_vp_videoAdBoxInside");this.elementAD.append(this.videoAdBoxInside);this.videoAdBoxInside.append('<p class="ult_vp_adsTitleInside">Your video will resume in</p>');this.videoAdBoxInside.append(this.timeLeftInside);this.videoAdBoxInside.hide();this.positionVideoAdBoxInside();
this.videoAdBoxInsideNowPlaying=b("<div />");this.videoAdBoxInsideNowPlaying.addClass("ult_vp_videoAdBoxInsideNowPlaying");this.elementAD.append(this.videoAdBoxInsideNowPlaying);this.videoAdBoxInsideNowPlaying.append('<p class="ult_vp_adsTitleInsideNowPlaying">Advertisement</p>');this.videoAdBoxInsideNowPlaying.hide()};c.fn.createEmbedWindowContent=function(){b(this.embedWindow).append('<p class="ult_vp_embedTitle">EMBED CODE:</p>');b(this.embedWindow).append('<p class="ult_vp_embedText"></p>');b(this.embedWindow).find(".ult_vp_embedText").css({opacity:.5});
var a=this.options.embedCodeSrc,c=this.options.embedCodeW,d=this.options.embedCodeH;b(this.embedWindow).find(".ult_vp_embedText").text("<iframe src='"+a+"' width='"+c+"' height='"+d+"' frameborder=0 webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");b(this.embedWindow).hide();this.positionEmbedWindow();b(this.embedWindow).mouseover(function(){b(this).find(".ult_vp_embedText").stop().animate({opacity:1},300)});b(this.embedWindow).mouseout(function(){b(this).find(".ult_vp_embedText").stop().animate({opacity:.5},
300)})};c.fn.ready=function(a){this.readyList.push(a);this.loaded&&a.call(this)};c.fn.load=function(a,c){var d=this;a&&(this.sources=a);"string"==typeof this.sources&&(this.sources={src:this.sources});b.isArray(this.sources)||(this.sources=[this.sources]);this.ready(function(){this.change("loading");"HTML5"==d.options.videoType&&this.video.loadSources(this.sources)})};c.fn.closeAD=function(){this.videoPlayingAD=!0;this.togglePlayAD();this._playlist.videoAdPlayed=!0;this.resetPlayerAD();this.elementAD.width(0);
this.elementAD.height(0);this.elementAD.css({zIndex:1});this.videoAdBoxInside.hide();this.skipAdBox.hide();this.fsEnterADBox.hide();this.toggleAdPlayBox.hide();this.videoAdBoxInsideNowPlaying.hide();"youtube"==this.options.videoType?(this.hideVideoElements(),this._playlist.youtubePlayer.playVideo()):"HTML5"==this.options.videoType?(this.showVideoElements(),this.togglePlay(),this.video.play()):"vimeo"==this.options.videoType&&(this.hideVideoElements(),void 0!=this._playlist.vimeoPlayer?this._playlist.vimeoPlayer.api("play"):
this._playlist.playVimeo(this._playlist.videoid));this.exitToOriginalSize()};c.fn.openAD=function(){this.showVideoElements();this.elementAD.css({zIndex:559});this.videoAdBoxInside.show();this.skipAdBox.show();this.fsEnterADBox.show();this.toggleAdPlayBox.show();this.hasTouch?this.ADTriggered||(b(this.toggleAdPlayBox).find(".ult_vp_toggleAdPlayBoxTitle").text("Play Ad"),this.videoPlayingAD=!0,this.togglePlayAD()):b(this.toggleAdPlayBox).find(".ult_vp_toggleAdPlayBoxTitle").text("Pause Ad");this.videoAdBoxInsideNowPlaying.show();
this.resizeAll()};c.fn.loadAD=function(a){a&&(this.sourcesAD=a);"string"==typeof this.sourcesAD&&(this.sourcesAD={src:this.sourcesAD});b.isArray(this.sourcesAD)||(this.sourcesAD=[this.sourcesAD]);this.ready(function(){this.change("loading");this.videoAD.loadSources(this.sourcesAD)})};c.fn.exitToOriginalSize=function(){THREEx.FullScreen.available()?THREEx.FullScreen.activated()?THREEx.FullScreen.cancel():this.inFullScreen&&this.fullScreen(!this.inFullScreen):THREEx.FullScreen.available();this.elementAD.css({zIndex:555})};
