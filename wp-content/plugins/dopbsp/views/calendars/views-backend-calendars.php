...
?>                  
                                ...
                                <a href="javascript:DOPBSPCalendar.duplicate()" class="dopbsp-button dopbsp-duplicate dopbsp-disabled"><span class="dopbsp-info"><?php echo $DOPBSP->text('CALENDARS_DUPLICATE_CALENDAR_SUBMIT'); ?></span></a>
